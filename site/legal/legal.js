(() => {
  ...
  function init() {
    ...
    close.addEventListener('click',()=>{note.hidden=true;links.querySelector('a:last-child').focus();});
    inner.append(text,close);note.append(inner);document.body.append(note);
  }
